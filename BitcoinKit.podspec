Pod::Spec.new do |spec|
  ...
  spec.description = <<-DESC
                       The BitcoinKit library is a Swift implementation of the Bitcoin(BCH/BTC) protocol. This library was originally made by Katsumi Kishikawa and Yenom Inc, and now is maintained by Jean-Baptiste Dominguez. It allows maintaining a wallet and sending/receiving transactions without needing a full blockchain node. It comes with a simple wallet app showing how to use it.
                       ```
                    DESC
  spec.homepage = 'https://github.com/jbdtky/BitcoinKit'
  spec.license = { :type => 'MIT', :file => 'LICENSE' }
  spec.authors = { 'Bitcoin Cash Supporters developers' => 'jbdtky', 'BitcoinKit developers' => 'usatie@yenom.tech' }

  spec.requires_arc = true
  spec.source = { git: 'https://github.com/jbdtky/BitcoinKit.git', tag: "v#{spec.version}" }
